...
dig = RES1 // 10 + RES1 % 10 + RES2 // 10 + RES2 % 10 + RES3 // 10 + RES3 % 10 \
    + RES4 // 10 + RES4 % 10 + RES5 // 10 + RES5 % 10 + RES6 // 10 + RES6 % 10 \
    + RES7 // 10 + RES7 % 10 + RES8 // 10 + RES8 % 10

print(dig)

# adds sum of multiplied digits to sum of unmultiplied digits
fin = dig + mod0 + ((mod2 - mod1) // 100) + (mod4 - mod3) // 10000 \
    + (mod6 - mod5) // 1000000 + (mod8 - mod7) // 100000000 \
    + (mod10 - mod9) // 10000000000 + (mod12 - mod11) // 1000000000000 \
    + (mod14 - mod13) // 100000000000000

print(fin)

if fin % 10 == 0:
    if (mod14 - mod12) // 10000000000000 == 34 \
            or (mod14 - mod12) // 10000000000000 == 37:
        print("AMEX")
    elif (mod15 - mod13) // 100000000000000 == 51 \
            or (mod15 - mod13) // 100000000000000 == 52 \
            or (mod15 - mod13) // 100000000000000 == 53 \
            or (mod15 - mod13) // 100000000000000 == 54 \
